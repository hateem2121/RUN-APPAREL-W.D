...
```bash
npx wrangler@4.140.0 r2 bucket create run-apparel-viewer-ingest
```
...
```bash
npx wrangler@4.140.0 queues create glb-shrink
npx wrangler@4.140.0 queues create glb-shrink-dlq
```
...
```bash
npx wrangler@4.140.0 queues update glb-shrink     --message-retention-period-secs 1209600
npx wrangler@4.140.0 queues update glb-shrink-dlq --message-retention-period-secs 1209600
```
