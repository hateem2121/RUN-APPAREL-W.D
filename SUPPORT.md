...
```mermaid
flowchart TB
  A["❓ I need help"] --> B{"Is it a security problem?"}
  B -- Yes --> C["🔒 Email team@wear-run.com<br/>subject: SECURITY"]
  B -- No --> D{"Is it in the picture guide?"}
  D -- Yes --> E["📖 Read the guide page"]
  D -- No --> F["✉️ Email team@wear-run.com"]
```
