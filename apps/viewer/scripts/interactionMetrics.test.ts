...
/**
 * PF-04 + PF-05 — see the e2e specs (`apps/viewer/e2e/perfBudgets.spec.ts`,
 * `apps/cms/e2e/perfBudgets.spec.ts`) for the live interaction walkthrough that
 * collects the raw samples these pure functions judge.
 */
